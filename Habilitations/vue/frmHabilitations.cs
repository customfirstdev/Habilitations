    ...
    public partial class FrmHabilitations : Form
    {
        ...
        private void BtnSupprimer_Click(object sender, System.EventArgs e)
        {
            if (dgvDeveloppeurs.SelectedRows.Count > 0)
            {
                ...
                else if (MessageBox.Show("Voulez-vous vraiment supprimer " + developpeur.Nom + " " + developpeur.Prenom + " ?", "Confirmation de suppression", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
